...
namespace MyProject
{
    public partial class create_account3 : Form
    {
        string cs = ConfigurationManager.ConnectionStrings["dbcs"].ConnectionString;
        public create_account3()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into General_SignUp values(@name,@email,@phone,@addr,@district,@area,@pass,@img)";
            ...
            if (a > 0)
            {
                ...
                this.Hide();
                Sign_in_form3 s3 = new Sign_in_form3();
                s3.ShowDialog();
            }
