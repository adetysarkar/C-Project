    ...
    public partial class AdminControlerTwo : UserControl
    {
        ...
        void GridView()
        {
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                string query = "select * from Applicant_SignUp";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                string query = "insert into Applicant_SignUp values(@name,@email,@phone,@addr,@district,@area,@img)";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                string query = "update Applicant_SignUp set Name=@name, Email=@email, Phone=@phone, Address=@addr, District=@district, Area=@area, Picture=@img where Name=@name";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.Parameters.AddWithValue("@name", textBox5.Text);
                cmd.Parameters.AddWithValue("@email", textBox4.Text);
                cmd.Parameters.AddWithValue("@phone", textBox3.Text);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "delete from Applicant_SignUp where Name=@Name";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.Parameters.AddWithValue("@Name", textBox5.Text);
        ...
        private void AdminControlerTwo_Load(object sender, EventArgs e)
        {
