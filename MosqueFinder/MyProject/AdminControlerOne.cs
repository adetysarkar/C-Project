...
namespace MyProject
{
    public partial class AdminControlerOne : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "insert into Recruiter_SignUp values(@name,@email,@phone,@addr,@district,@area,@img)";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "update Recruiter_SignUp set Name=@name, Email=@email, Phone=@phone, Address=@addr, District=@district, Area=@area, Picture=@img where Name=@name";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.Parameters.AddWithValue("@name", textBox5.Text);
                cmd.Parameters.AddWithValue("@email", textBox4.Text);
                cmd.Parameters.AddWithValue("@phone", textBox3.Text);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "delete from Recruiter_SignUp where Username=@Username";
                SqlCommand cmd = new SqlCommand(query, con);
        ...
        private void AdminControlerOne_Load(object sender, EventArgs e)
        {
