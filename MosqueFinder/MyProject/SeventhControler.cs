    ...
    public partial class SeventhControler : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                c.Open();
                string queary = "update Recruiter_SignUp set Email=@Email,Phone=@Phone,Addres=@Addres,District=@District,Area=@Area,Picture=@Picture where Name=@Name";
        ...
        void BindGridView()
        {
            ...
            string query = "select * from Recruiter_SignUp where Username=@Username";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@Username", Sign_in_form.name);
