    ...
    public partial class GeneralControlerSix : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                c.Open();
                string queary = "update General_Pofile set Email=@Email,Phone=@Phone,Address=@Address,District=@District,Area=@Area,Picture=@Picture where Name=@Name";
        ...
        void BindGridView()
        {
            ...
            string query = "select * from General_SignUp where Username=@Username";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@Username", Sign_in_form3.name);
